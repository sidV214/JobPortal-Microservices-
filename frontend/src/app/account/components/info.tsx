...
const Info: React.FC<AccontProps> = ({ user, isYourAccount }) => {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8">
      <Card className="overflow-hidden glass-panel border-slate-700/50">
        <div className="h-32 bg-gradient-to-r from-indigo-500/80 to-purple-500/80 relative">
          <div className="absolute -bottom-16 left-8">
            <div className="relative group">
              <div className="w-32 h-32 rounded-full border-4 border-slate-900 overflow-hidden shadow-[0_0_20px_rgba(99,102,241,0.3)] bg-slate-900">
                <img
        ...
        <div className="pt-20 pb-8 px-8">
          ...
          {user.role === "jobseeker" && user.bio && (
            <div className="mt-6 p-4 rounded-lg glass-panel text-slate-200 border-slate-700/50">
          ...
          <div className="mt-8">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="flex items-center gap-3 p-4 rounded-lg border border-slate-700/50 hover:border-indigo-500/50 transition-colors bg-slate-900/50">
...
/*
 * ===========================================================================================
 *                              NOTES — frontend/src/app/account/components/info.tsx
 * ===========================================================================================
 *
 * PURPOSE: User profile information section. Shows avatar, name, email, phone, bio, resume,
 * subscription status, and role. Editable when isYourAccount=true.
 *
 * PROPS: { user: User, isYourAccount: boolean }
 *
 * EDITING FEATURES (when isYourAccount=true):
 * - Profile picture upload (click avatar → file input → updateProfilePic via context)
 * - Resume upload (click resume section → file input → updateResume via context)
 * - Edit profile dialog (name, phone, bio) → updateUser via context
 * - Subscribe button → links to /subscribe
 *
 * SUBSCRIPTION DISPLAY:
 * - Active subscription: green "Premium" badge with expiry date
 * - Expired/none: yellow "Free" badge with upgrade CTA
 *
 * CONNECTIONS:
 * • AppContext → updateProfilePic, updateResume, updateUser
 * • /subscribe → subscription upgrade link
 * • /account and /account/[id] → both render this component
 */
