...
/*
 * ===========================================================================================
 *                              NOTES — frontend/src/app/account/components/skills.tsx
 * ===========================================================================================
 *
 * PURPOSE: Skill tag management section for jobseekers.
 * Displays current skills as removable pills and provides input to add new ones.
 *
 * PROPS: { user: User, isYourAccount: boolean }
 *
 * WHEN isYourAccount=true:
 * - Shows "Add Skill" input with add button
 * - Each skill pill has an X button to remove it
 * - addSkill() and removeSkill() from AppContext
 *
 * WHEN isYourAccount=false:
 * - Read-only display of skill pills (no add/remove buttons)
 *
 * CONNECTIONS: AppContext → addSkill, removeSkill functions
 */
