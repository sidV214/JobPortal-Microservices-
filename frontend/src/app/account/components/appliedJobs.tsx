...
/*
 * ===========================================================================================
 *                              NOTES — frontend/src/app/account/components/appliedJobs.tsx
 * ===========================================================================================
 *
 * PURPOSE: Displays the jobseeker's application history with status indicators.
 *
 ...
 * - Applied date
 * - Status badge (Submitted=blue, Hired=green, Rejected=red)
 * - Resume link (the version submitted at time of application)
 *
 * STATUS COLOR CODING:
 ...
 *
 * CONNECTIONS:
 * • AppContext → applications[] (fetched in context on app mount)
 * • /account page → renders this component for jobseekers only
 */
