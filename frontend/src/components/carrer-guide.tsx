  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-16">
      <div className="text-center mb-12">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-purple-500/30 bg-purple-500/10 backdrop-blur-md shadow-[0_0_15px_rgba(168,85,247,0.2)] mb-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {skills.map((s) => (
                          <div
                            key={s}
                            className="inline-flex items-center gap-2 pl-3 pr-2 py-1.5 rounded-full bg-purple-500/20 border border-purple-500/40 shadow-sm"
                          >
...
/*
 * ===========================================================================================
 *                              NOTES — frontend/src/components/carrer-guide.tsx
 * ===========================================================================================
 *
 * PURPOSE: AI-powered career path advisor component. Users input their skills and receive
 * personalized career recommendations, job options, and a learning roadmap.
 *
 * DATA FLOW:
 * 1. User adds skills via input (Enter key or Add button)
 * 2. Skills stored in local state as string array, displayed as removable pills
 * 3. Click "Generate" → POST skills to utils_service/api/utils/career
 * 4. Backend sends skills to Gemini AI → returns structured JSON response
 * 5. Response rendered in 4 sections: Summary, Job Options, Skills to Learn, Learning Approach
 *
 * UI PATTERN: Dialog-based. CTA button opens dialog → input phase → results phase
 * - Phase 1: Skill input form (before response)
 * - Phase 2: AI results display (after response)
 * - "Start New Analysis" resets to Phase 1
 *
 * CONNECTIONS:
 * • Utils Service /api/utils/career → Gemini AI integration
 * • type.ts → CareerGuideResponse interface
 */
